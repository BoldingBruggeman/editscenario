...
#    parser.add_argument('targetpath',help='Output XML-formatted file')
...
#KB    parser.add_argument('-e','--export', choices=('xml','dir','zip'), help='Output type: xml = XML-based values file [default], dir = directory with XML-based values file and associated data, zip = zip file with XML-based values file and associated data.')
...
#KB    if len(args)<3:
#KB        print '3 arguments required:\n- path to the schema file.\n- path to the directory with namelists.\n- path to save the XML values file to.'
#KB        return 2

    # Get command line arguments
#KB    schemapath = os.path.abspath(args.pop(0))
#KB    nmlpath    = os.path.abspath(args.pop(0))
#KB    targetpath = os.path.abspath(args.pop(0))
